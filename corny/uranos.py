...
class URANOS:
    ...
    def material2sm(self):
        ...
        nearby_avg_sm = self.SM[self.m2grd(-50):self.m2grd(50), self.m2grd(-50):self.m2grd(50)]
    ...
    def plot(self, ax=None, image='SM', annotate=None, overlay=None, fontsize=10, title=None,
             regions=None, extent=500, cmap='Greys', vmax_factor=2, x_marker=None):
        """
        ...
        for i in regions:
            ...
            ax.annotate('{0:{1}}'.format(dataset[annotate], self.variable_formats[annotate]), dataset['center_mass'], fontsize=fontsize, ha='center', va='center')
        ...
        ax.plot(self.m2grd(0),self.m2grd(0), color='black', marker='+', ms=10, mew=1, alpha=0.5)
